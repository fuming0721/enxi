<template lang='pug'>
  .registerForm
    van-form(@submit="onSubmit")
      ...
      van-field.registerForm_item(v-model="formData.mobile" label="手机号码" placeholder='请输入手机号码' type='tel' clearable label-align='top' :rules="[{ validator: validatorMobile, message: '请输入正确手机号码' }]")
...
import { isMobile, validatePass } from '@/config/validation'
